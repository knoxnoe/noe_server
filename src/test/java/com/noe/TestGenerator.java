...
public class TestGenerator {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("lian")
                .setOutputDir("E:\\FullStack\\noeServer\\src\\main\\java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/noeServer?serverTimezone=UTC")
        ...
        packageConfig.setParent("com.noe").setMapper("mapper")
